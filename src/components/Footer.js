...
function FooterColumn({ title, caption, links }) {
  return (
    <div className="rounded-[28px] border border-slate-200 bg-white/80 p-6 text-right shadow-[0_16px_40px_rgba(15,23,42,0.05)]">
      <p className="text-xs font-semibold uppercase tracking-[0.38em] text-slate-800">{caption}</p>
          ...
          <div className="grid gap-8 border-b border-slate-200 pb-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <div className="text-right">
              <div className="inline-flex items-center gap-3">
                <span className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#111111,#000000)] text-xl font-black text-white shadow-lg shadow-black/25">
                  C
                </span>
                <div>
              ...
              <div className="mt-6 flex flex-wrap justify-end gap-3">
                <span className="rounded-full border border-slate-300 bg-slate-100 px-4 py-2 text-sm font-semibold text-slate-900">
            ...
            <div className="rounded-[28px] bg-[linear-gradient(145deg,#0f172a,#020617)] p-6 text-right text-white shadow-[0_18px_50px_rgba(2,6,23,0.3)]">
              ...
              <a
                className="mt-5 inline-flex rounded-full bg-black px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-black/90"
