    ...
    <div className="overflow-x-hidden">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.08fr_0.92fr]">
          <div className="text-right">
            <h1 className="mt-6 max-w-3xl text-5xl font-black leading-[1.15] text-slate-950 sm:text-6xl">
              منصة دردشة وقنوات
              <span className="block bg-[linear-gradient(135deg,#111827,#020617)] bg-clip-text text-transparent">
            ...
            <div className="mt-3 flex w-full justify-center lg:hidden">
              <Image
                ...
                height={1466}
                priority
                className="h-auto w-[94%] max-w-[420px] drop-shadow-[0_24px_40px_rgba(15,23,42,0.22)]"
              />
            </div>
            ...
            <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <Link
                href="/download"
                className="inline-flex items-center justify-center rounded-full bg-[linear-gradient(135deg,#111827,#020617)] px-8 py-3.5 text-base font-semibold text-white shadow-xl shadow-black/25 transition-transform hover:-translate-y-0.5"
              >
                تنزيل كراكساب
              </Link>
              <Link
                href="/features"
                className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-8 py-3.5 text-base font-semibold text-slate-900 shadow-sm transition hover:border-slate-400 hover:text-slate-900"
              >
                استكشاف المزايا
              </Link>
            </div>
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="relative mx-auto flex w-full max-w-[420px] items-end justify-center lg:max-w-[520px]">
              ...
              <Image
                ...
                height={1466}
                priority
                className="relative h-auto w-[92%] max-w-[430px] drop-shadow-[0_35px_60px_rgba(15,23,42,0.25)] sm:w-[90%]"
              />
            </div>
          </div>
        </div>
          ...
          {promoBanners.map((banner, index) => (
            <article
              ...
              className={`rounded-[32px] p-7 text-right shadow-[0_18px_50px_rgba(15,23,42,0.08)] ${
                index === 1
                  ? 'bg-[linear-gradient(140deg,#0f172a,#020617)] text-white'
            ...
            >
              ...
              <span
                className={`mt-6 inline-flex rounded-full px-4 py-2 text-sm font-semibold ${
                  index === 1 ? 'bg-black text-white' : 'bg-slate-950 text-white'
                }`}
              >
                {banner.cta}
              </span>
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {featureGrid.map((item) => (
            <article key={item.title} className="rounded-[30px] border border-white/80 bg-white/85 p-7 text-right shadow-[0_18px_45px_rgba(15,23,42,0.06)]">
              <p className="text-xs font-semibold uppercase tracking-[0.38em] text-slate-800">{item.eyebrow}</p>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr]">
              ...
              {timeline.map((item) => (
                <article key={item.step} className="rounded-[24px] bg-slate-50 p-5">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-2xl font-black text-slate-800">{item.step}</span>
                  </div>
                  <p className="mt-3 text-sm leading-7 text-slate-600">{item.text}</p>
                </article>
              ))}
          ...
          <div className="rounded-[34px] bg-[linear-gradient(145deg,#111827,#020617)] p-8 text-right text-white shadow-[0_28px_70px_rgba(2,6,23,0.28)]">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="rounded-[34px] bg-[linear-gradient(145deg,#111827,#020617)] p-8 text-right text-white shadow-[0_28px_70px_rgba(2,6,23,0.3)]">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-end">
              <Link
                href="/download"
                className="inline-flex items-center justify-center rounded-full bg-black px-7 py-3 text-base font-semibold text-white transition hover:bg-black/90"
              >
                ابدأ التنزيل
              </Link>
              <Link
